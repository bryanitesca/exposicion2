...
class GlobosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_globos, container, false)
                ...
                if (list.isNotEmpty()) {
                    val adapter = BannerAdapter(list) { pos ->
                        ...
                        val options = NavOptions.Builder()
                            .setPopUpTo(R.id.nav_globos, false)
                            .build()
                        findNavController().navigate(
                            R.id.action_nav_globos_to_globosOffersFragment,
                            args,
                            options
                        )
                    }
