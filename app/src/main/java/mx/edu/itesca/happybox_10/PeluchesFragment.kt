...
class PeluchesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_peluches, container, false)
        ...
        db.collection("Productos")
            .whereEqualTo("tipoProducto", "Peluches")
            .limit(5)
            .get()
                ...
                if (list.isNotEmpty()) {
                    val adapter = BannerAdapter(list) { pos ->
                        ...
                        val opts = NavOptions.Builder()
                            .setPopUpTo(R.id.nav_peluches, false)
                            .build()
                        findNavController().navigate(
                            R.id.action_nav_peluches_to_peluchesOffersFragment,
                            args,
                            opts
                        )
                    }
